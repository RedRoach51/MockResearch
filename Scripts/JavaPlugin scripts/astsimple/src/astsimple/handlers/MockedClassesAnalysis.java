...
public class MockedClassesAnalysis {
	...
	static String folderPath = "E:\\eclipse\\SummerResearch"; 
	static String undProjectPath = "C:\\Users\\RedRo\\OneDrive\\Documents\\Academic Texts\\Summer Research\\UndProjects";
	...
	public static void ReadFile(final File file) throws FileNotFoundException, IOException {
		...
		PrintWriter writer = new PrintWriter (folderPath + "\\RQ3 result\\" + ProjectName + " filtered mocked classes.txt", "UTF-8");
	...
	public static void output() throws IOException {
		...
		FileWriter newFile = new FileWriter(folderPath + "\\RQ3 result\\summary.csv");
...
//					calculate total number of classes created for each project;
	...
	public static void output2() throws IOException {
		FileWriter newFile = new FileWriter(folderPath + "\\RQ3 result\\proportion of mocked classes.csv");
	...
	public static void output3() throws IOException {
		FileWriter newFile = new FileWriter(folderPath + "\\RQ3 result\\outside mocked classes summary.csv");
...
//		System.out.println(a.substring(0,b));
		...
		final File folder = new File(folderPath + "\\RQ3_data");
		ReadAllFiles(folder);
