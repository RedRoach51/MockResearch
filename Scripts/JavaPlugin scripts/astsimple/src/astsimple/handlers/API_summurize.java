...
//				System.out.println(result);
	...
	public static void output() {
		...
		try {
			FileWriter newFile2 = new FileWriter(folderPath + "\\RQ2 needed data\\mocked objects in single file summary.csv");
...
//				ALL.get(i).get(j)
			...
			try {
				FileWriter newFile = new FileWriter(folderPath + "\\Mocking_frameworks_API_usage_summary\\" + frameworks.get(i) +".csv");
